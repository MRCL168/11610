/* ============================================================
   partials/header.js — Header & navigasi (TEMA Pesantren)
   Header lengket dengan logo, menu (mendukung submenu bertingkat),
   dan satu tombol CTA "Daftar" untuk konversi. Drawer mobile aman
   (lihat catatan anti containing-block di style.css).
   ============================================================ */
...
module.exports = function header(ctx) {
  ...
  // Tombol CTA header: teks & URL dapat diubah; disembunyikan di mobile via CSS.
