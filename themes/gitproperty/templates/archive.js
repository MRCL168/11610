/* ============================================================
   templates/archive.js — Arsip kategori / tag (TEMA Gitproperty)
   Memakai grid properti; postCard otomatis memilih kartu properti
   atau kartu artikel sesuai isi tiap post.
...
module.exports = function archive(ctx) {
  ...
  var intro = hasDesc ? "<p>" + esc(description) + "</p>" : "<p>" + posts.length + " properti & artikel</p>";
