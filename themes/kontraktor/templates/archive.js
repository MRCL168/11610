/* ============================================================
   templates/archive.js — Arsip kategori/tag tema Kontraktor
   Merender daftar artikel dari data yang sudah disiapkan inti.
   ============================================================ */
...
module.exports = function archive(ctx) {
  ...
  var intro = description && String(description).trim() ? '<p>' + esc(description) + '</p>' : '<p>' + posts.length + ' artikel</p>';
  var head = '\n    <section class="page-head"><div class="container"><span class="page-head-kicker">' + label + '</span><h1>' + esc(term) + '</h1>' + intro + '</div></section>';
